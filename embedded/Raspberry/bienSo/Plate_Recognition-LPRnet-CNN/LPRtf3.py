...
class TextImageGenerator:
    def __init__(self, img_dir, label_file, batch_size, img_size, num_channels=3, label_len=label_len):
    ...
    def next_batch(self):
        ...
        # print(sparse_labels,seq_len,sep="->")
...
def train(a):
    ...
    def report_accuracy(decoded_list, test_targets):
        ...
        if len(original_list) != len(detected_list):
            ...
            return
        print("T/F:                               original  <------->  detectcted")
        original_number = original_list[0]
        detect_number = detected_list[0]
        hit = (original_number == detect_number)
        print(hit, original_number," <-------> ".encode("utf-8"), detect_number)
        if hit:
    ...
    def test_report(testi,files):
        ...
        for i in range(num):
            ...
            for idx, number in enumerate(original_list):
                ...
                if hit:
                    true_number = true_number + 1
        print("Test Accuracy:", true_number * 1.0 / files)
